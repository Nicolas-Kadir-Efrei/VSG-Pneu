...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Oui, nos prestations sont garanties : 6 mois pour les réparations de crevaison, 1 mois pour l'équilibrage. Le montage est garanti contre les défauts de pose."
    }
  ]
