      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <a href="tel:0143896808" className="hover:text-red-500 transition-colors">
                  01 43 89 68 08
                </a>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link href="/rendez-vous" className="hover:text-red-500 transition-colors">
                  Prendre rendez-vous
                </Link>
              </li>
              <li>
                <Link href="/devis" className="hover:text-red-500 transition-colors">
                  Demander un devis
                </Link>
              </li>
              <li>
                <Link href="/avis" className="hover:text-red-500 transition-colors">
                  Avis clients
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 text-sm text-gray-400 mt-4 md:mt-0">
            ...
            <Link href="/confidentialite" className="hover:text-red-500 transition-colors">
              Confidentialité
            </Link>
